...
urlpatterns = [
    ...
    path("settings/integrations/instagram/connect/", views.instagram_connect, name="instagram_connect"),
    path("settings/integrations/instagram/callback/", views.instagram_callback, name="instagram_callback"),
    path("settings/integrations/instagram/account/", views.instagram_select_account, name="instagram_select_account"),
